...
def crop_prediction():
    ...
    if request.method == 'POST':
        ...
        if weather_fetch(city) != None:
            ...
            predictions = zip(top_crops, top_probs)

            return render_template('crop-result.html', predictions=predictions, title=title)
...
def security():
    try:
        ...
        subprocess.Popen(['python', 'C:\\data\\dsatm\\4th sem\\cypherquest\\Smart Farming with AI\\plantprotector-DSATM\\security.py'])
        return render_template('security.html', title='Intrudeer Alarm')
